...
import (
	...
	"github.com/hencya/go-api-crud/helper"
	"github.com/hencya/go-api-crud/models"
	"github.com/hencya/go-api-crud/service"
)

//DestinationController is a a contract what this controller can do
...
func (c *destinationController) All(context *gin.Context) {
	var destinations []models.Destination = c.destinationService.All()
...
func (c *destinationController) FindByID(context *gin.Context) {
	...
	var destination models.Destination = c.destinationService.FindByID(id)
	if (destination == models.Destination{}) {
